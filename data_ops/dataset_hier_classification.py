...
dfas_to_cerkez_lookup = {
    "araç": "arac",
    "askeri araç": "askeri arac",
    "sivil araç": "sivil arac",
    "askeri insan": "askeri",
    "sivil insan": "sivil",
    "silahlı asker": "silahlı",
    "silahsız asker": "silahsız",
    "lastikli araç": "lastikli",
    "Tank": "tank",
    "ZPT": "ZMA",
    "Tank-M48": "m48",
    "Tank-M60": "m60",
    "Tank-leopard": "leopard",
}
...
class DataParserDFAS:
    ...
    def split_dataset(self, train_ratio=4 / 5):
        ...
        number_per_classes_per_split = {
            data_split: {class_name: 0 for class_name in dfas_classes} for data_split in ["train", "val", "test"]
        }
        ...
        for k in range(length):
            ...
            while cap.isOpened():
                ...
                for box in img.iter("box"):
                    ...
                    dfas_version_of_label = (
                        most_specific_label
                        if (cerkez_to_dfas_lookup.get(most_specific_label) is None)
                        else cerkez_to_dfas_lookup[most_specific_label]
                    )
...
if __name__ == "__main__":
    ...
    dataset_list = [
        "hier_clasification_dataset/clasification_dataset_cerkez",
        "hier_clasification_dataset/clasification_dataset_dfas",
    ]
